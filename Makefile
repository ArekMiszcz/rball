...
export-aarch64-linux-android-debug: clean build-aarch64-linux-android-debug
	cd godot/ ; godot --export-debug "Android.aarch64-linux-android.debug" ../bin/aarch64-linux-android/rball.debug.aarch64-linux-android.apk
...
export-aarch64-linux-android-release: clean build-aarch64-linux-android-release
	cd godot/ ; godot --export "Android.aarch64-linux-android.release" ../bin/aarch64-linux-android/rball.release.aarch64-linux-android.apk
...
export-armv7-linux-androideabi-debug: clean build-armv7-linux-androideabi-debug
	cd godot/ ; godot --export-debug "Android.armv7-linux-androideabi.debug" ../bin/armv7-linux-androideabi/rball.debug.armv7-linux-androideabi.apk
...
export-armv7-linux-androideabi-release: clean build-armv7-linux-androideabi-release
	cd godot/ ; godot --export "Android.armv7-linux-androideabi.release" ../bin/armv7-linux-androideabi/rball.release.armv7-linux-androideabi.apk
...
export-i686-linux-android-debug: clean build-i686-linux-android-debug
	cd godot/ ; godot --export-debug "Android.i686-linux-android.debug" ../bin/i686-linux-android/rball.debug.i686-linux-android.apk
...
export-i686-linux-android-release: clean build-i686-linux-android-release
	cd godot/ ; godot --export "Android.i686-linux-android.release" ../bin/i686-linux-android/rball.release.i686-linux-android.apk
...
export-x86_64-linux-android-debug: clean build-x86_64-linux-android-debug
	cd godot/ ; godot --export-debug "Android.x86_64-linux-android.debug" ../bin/x86_64-linux-android/rball.debug.x86_64-linux-android.apk
...
export-x86_64-linux-android-release: clean build-x86_64-linux-android-release
	cd godot/ ; godot --export "Android.x86_64-linux-android.release" ../bin/x86_64-linux-android/rball.release.x86_64-linux-android.apk
...
export-i686-unknown-linux-gnu-debug: clean build-i686-unknown-linux-gnu-debug
	cd godot/ ; godot --export-debug "Linux/X11.i686-unknown-linux-gnu.debug" ../bin/i686-unknown-linux-gnu/rball.debug.i686-unknown-linux-gnu
...
export-i686-unknown-linux-gnu-release: clean build-i686-unknown-linux-gnu-release
	cd godot/ ; godot --export "Linux/X11.i686-unknown-linux-gnu.release" ../bin/i686-unknown-linux-gnu/rball.release.i686-unknown-linux-gnu

build-x86_64-unknown-linux-gnu-debug:
	cargo build --target x86_64-unknown-linux-gnu
	mv -b ./target/x86_64-unknown-linux-gnu/debug/*.so ./godot/lib/x86_64-unknown-linux-gnu.so

export-x86_64-unknown-linux-gnu-debug: clean build-x86_64-unknown-linux-gnu-debug
	cd godot/ ; godot --export-debug "Linux/X11.x86_64-unknown-linux-gnu.debug" ../bin/x86_64-unknown-linux-gnu/rball.debug.x86_64-unknown-linux-gnu
...
export-x86_64-unknown-linux-gnu-release: clean build-x86_64-unknown-linux-gnu-release
	cd godot/ ; godot --export "Linux/X11.x86_64-unknown-linux-gnu.release" ../bin/x86_64-unknown-linux-gnu/rball.release.x86_64-unknown-linux-gnu
...
export-x86_64-apple-darwin-debug: clean build-x86_64-apple-darwin-debug
	cd godot/ ; godot --export-debug "Mac OSX.x86_64-apple-darwin.debug" ../bin/x86_64-apple-darwin/rball.debug.x86_64-apple-darwin
...
export-x86_64-apple-darwin-release: clean build-x86_64-apple-darwin-release
	cd godot/ ; godot --export "Mac OSX.x86_64-apple-darwin.release" ../bin/x86_64-apple-darwin/rball.release.x86_64-apple-darwin
...
export-aarch64-apple-ios-debug: clean build-aarch64-apple-ios-debug
	cd godot/ ; godot --export-debug "iOS.aarch64-apple-ios.debug" ../bin/aarch64-apple-ios/rball.debug.aarch64-apple-ios.ipa
...
export-aarch64-apple-ios-release: clean build-aarch64-apple-ios-release
	cd godot/ ; godot --export "iOS.aarch64-apple-ios.release" ../bin/aarch64-apple-ios/rball.release.aarch64-apple-ios.ipa
...
export-i686-pc-windows-gnu-debug: clean build-i686-pc-windows-gnu-debug
	cd godot/ ; godot --export-debug "Windows Desktop.i686-pc-windows-gnu.debug" ../bin/i686-pc-windows-gnu/rball.debug.i686-pc-windows-gnu.exe
...
export-i686-pc-windows-gnu-release: clean build-i686-pc-windows-gnu-release
	cd godot/ ; godot --export "Windows Desktop.i686-pc-windows-gnu.release" ../bin/i686-pc-windows-gnu/rball.release.i686-pc-windows-gnu.exe
...
export-x86_64-pc-windows-gnu-debug: clean build-x86_64-pc-windows-gnu-debug
	cd godot/ ; godot --export-debug "Windows Desktop.x86_64-pc-windows-gnu.debug" ../bin/x86_64-pc-windows-gnu/rball.debug.x86_64-pc-windows-gnu.exe
...
export-x86_64-pc-windows-gnu-release: clean build-x86_64-pc-windows-gnu-release
	cd godot/ ; godot --export "Windows Desktop.x86_64-pc-windows-gnu.release" ../bin/x86_64-pc-windows-gnu/rball.release.x86_64-pc-windows-gnu.exe
...
export-i686-pc-windows-msvc-debug: clean build-i686-pc-windows-msvc-debug
	,cd godot/ ; godot --export-debug "Windows Desktop.i686-pc-windows-msvc.debug" ../bin/i686-pc-windows-msvc/rball.debug.i686-pc-windows-msvc.exe
...
export-i686-pc-windows-msvc-release: clean build-i686-pc-windows-msvc-release
	cd godot/ ; godot --export "Windows Desktop.i686-pc-windows-msvc.release" ../bin/i686-pc-windows-msvc/rball.release.i686-pc-windows-msvc.exe
...
export-x86_64-pc-windows-msvc-debug: clean build-x86_64-pc-windows-msvc-debug
	cd godot/ ; godot --export-debug "Windows Desktop.x86_64-pc-windows-msvc.debug" ../bin/x86_64-pc-windows-msvc/rball.debug.x86_64-pc-windows-msvc.exe
...
export-x86_64-pc-windows-msvc-release: clean build-x86_64-pc-windows-msvc-release
	cd godot/ ; godot --export "Windows Desktop.x86_64-pc-windows-msvc.release" ../bin/x86_64-pc-windows-msvc/rball.release.x86_64-pc-windows-msvc.exe
...
create-debug-keystore:
	keytool -keyalg RSA -genkeypair -alias androiddebugkey -keypass android -keystore rball.debug.keystore -storepass android -dname "CN=Android Debug,O=Android,C=US" -validity 9999 -deststoretype pkcs12

create-release-keystore:
	keytool -v -genkey -v -keystore rball.release.keystore -alias rball -keyalg RSA -validity 10000
...
server:
	cargo build --target x86_64-unknown-linux-gnu -p server
	cargo run --target x86_64-unknown-linux-gnu -p server
